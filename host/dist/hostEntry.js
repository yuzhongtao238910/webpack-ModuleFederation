...
var moduleMap = {
	"./Host": () => {
		return Promise.all([__webpack_require__.e("webpack_sharing_consume_default_react_react"), __webpack_require__.e("src_Host_js")]).then(() => (() => ((__webpack_require__(/*! ./src/Host */ "./src/Host.js")))));
	}
};
